...
namespace TestProject1.SchemaGenerator
{
    ...
    [TestFixture("MSAzureSynapseForSDI")]
    public class UTSchemaGeneratorAzureSynapse2(string dBType) : MSAzureSynapseSchemaGenerator(dBType)
    {
        ...
        {
            //Arrange:初始化
            string path = "C:\\Users\\Joery\\Downloads\\SQLString\\MS_Azure_Synapse_SQL2\\";
