...
using SchemaGenerator.PostgreSQL;
...
namespace TestProject1.SchemaGenerator
{
    ...
    public class UTSchemaGeneratorPostgreSQL : PostgreSQLSchemaGenerator
    {
        ...
        public UTSchemaGeneratorPostgreSQL(string dBType) : base(dBType)
        {
            this._dbType = dBType;
        }
        ...
        {
            //Arrange:初始化
            string path = "C:\\Users\\Joery\\Downloads\\SQLString\\PostgreSQL\\";
